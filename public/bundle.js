...
/***/ function(module, exports, __webpack_require__) {
	...
	var TwoPage = function (_Component2) {
	  _inherits(TwoPage, _Component2);

	  function TwoPage() {
	    _classCallCheck(this, TwoPage);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TwoPage).apply(this, arguments));
	  }

	  _createClass(TwoPage, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	  ...
	  _createClass(Main, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactRouter.Route, { path: 'two', component: TwoPage })
	      );
	    }
	  }]);
